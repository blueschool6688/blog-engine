import { c as mediaService, s as getFullUrl } from "./api-CItDfJrl.js";
...
import { Eye, Film, Image, Loader, Play, RefreshCw, Search, Trash2, Upload, X } from "lucide-react";
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: "Drag & Drop images or videos here to upload them directly"
					}),
					/* @__PURE__ */ jsx("p", {
						className: "text-xs text-gray-600 mt-1 font-sans",
						children: "Max sizes: Image 10MB, Video 500MB"
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [isProcessing ? /* @__PURE__ */ jsxs("div", {
								...
								children: /* @__PURE__ */ jsxs("span", {
									...
									children: [media.type === "video" ? /* @__PURE__ */ jsx(Film, { className: "w-2.5 h-2.5" }) : /* @__PURE__ */ jsx(Image, { className: "w-2.5 h-2.5" }), media.type]
								})
							})]
						}), /* @__PURE__ */ jsxs("div", {
