import { c as mediaService, l as postService, p as tagService, r as categoryService, s as getFullUrl } from "./api-CItDfJrl.js";
...
import { ArrowLeft, Bold, Check, Eraser, FileText, Film, GripVertical, Heading1, Heading2, Heading3, Image, Italic, Link as Link$1, List, ListOrdered, Loader, Minus, Play, Plus, Quote, Save, Search, Trash, Trash2, X } from "lucide-react";
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Link, {
						...
						children: isEdit ? "Chỉnh sửa bài viết" : "Tạo bài viết mới"
					}), /* @__PURE__ */ jsx("p", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("span", {
													...
													children: "Google Preview Mockup"
												}), /* @__PURE__ */ jsxs("div", {
													className: "space-y-1",
													children: [
														/* @__PURE__ */ jsx("span", {
						...
						children: [
								...
								children: [/* @__PURE__ */ jsx("h3", {
									...
									children: [
										...
										/* @__PURE__ */ jsx(Form.Item, {
											label: /* @__PURE__ */ jsx("span", {
												className: "text-xs font-bold text-gray-400 uppercase tracking-wider",
												children: "Publish Date & Time (Schedule)"
											}),
											name: "published_at",
										...
										isDocVal && /* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												selectedPDF ? /* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx(FileText, { className: "w-4 h-4" }), "Select PDF File"]
												})
											]
										})
									]
							...
							/* @__PURE__ */ jsx(Button, {
								...
								children: isEdit ? "Save Changes" : "Publish Article"
							})
						]
					})]
				})
