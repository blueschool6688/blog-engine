import { d as publicService, f as settingsService, s as getFullUrl } from "./api-CItDfJrl.js";
		...
		children: [
			...
			loading ? /* @__PURE__ */ jsx("div", {
				...
				children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsx("div", {
					className: "flex gap-5 p-5 bg-white dark:bg-slate-900/40 border border-slate-200/80 dark:border-slate-800/80 rounded-2xl animate-pulse",
