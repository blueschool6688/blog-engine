...
import { ArrowRight, Info, Loader, Mail, Users } from "lucide-react";
...
var AuthorsList = () => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsxs("div", {
				className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accentBlue/10 text-accentBlue text-xs font-semibold mb-3",
				children: [/* @__PURE__ */ jsx(Users, { className: "w-3.5 h-3.5" }), /* @__PURE__ */ jsx("span", { children: t("our_writers") })]
			}),
			/* @__PURE__ */ jsx("h1", {
			...
			className: "py-20 text-center space-y-4 animate-pulse",
