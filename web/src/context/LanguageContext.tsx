...
const dictionary: Dictionary = {
  ...
  translate_jobs: { vi: 'Dịch thuật AI', en: 'Translate Jobs' },
  chat_logs: { vi: 'Nhật ký chat RAG', en: 'RAG Chat Logs' },
  document_parser: { vi: 'Parse tài liệu', en: 'Document Parser' },
  sign_out: { vi: 'Đăng xuất', en: 'Sign Out' },
  parser_title: { vi: 'Nhập Liệu & Parse Tài Liệu', en: 'Document Parsing & Import' },
  parser_subtitle: { vi: 'Convert tài liệu PDF/DOCX thành nội dung blog Markdown chất lượng cao bằng MinerU', en: 'Convert PDF/DOCX documents to high-quality Markdown blog content using MinerU' },
  upload_zone_title: { vi: 'Kéo thả file vào đây hoặc click để chọn file', en: 'Drag & drop a file here or click to select file' },
  upload_zone_hint: { vi: 'Hỗ trợ các định dạng PDF và DOCX. Dung lượng tối đa 50MB.', en: 'Supports PDF and DOCX formats. Max file size is 50MB.' },
  parsing_progress_step1: { vi: 'Đang upload file lên hệ thống...', en: 'Uploading file to server...' },
  parsing_progress_step2: { vi: 'Đang chạy MinerU Layout Analysis (CPU)...', en: 'Running MinerU layout analysis (CPU)...' },
  parsing_progress_step3: { vi: 'Đang trích xuất cấu trúc văn bản, bảng biểu...', en: 'Extracting text structure and tables...' },
  parsing_progress_step4: { vi: 'Đang lưu trữ & liên kết hình ảnh...', en: 'Saving and linking extracted images...' },
  parser_edit_content: { vi: 'Chỉnh sửa Markdown', en: 'Edit Markdown' },
  parser_preview_content: { vi: 'Xem trước bài viết', en: 'Preview Article' },
  parser_copy_btn: { vi: 'Sao chép Markdown', en: 'Copy Markdown' },
  parser_create_post_btn: { vi: 'Tạo bài viết mới', en: 'Create New Post' },
  parser_error_invalid_type: { vi: 'Định dạng file không được hỗ trợ! Chỉ chấp nhận file PDF hoặc DOCX.', en: 'Unsupported file format! Only PDF or DOCX files are allowed.' },
  parser_error_too_large: { vi: 'Dung lượng file quá lớn! Vui lòng chọn file dưới 50MB.', en: 'File is too large! Please choose a file smaller than 50MB.' },
  bot_greeting: { vi: 'Xin chào! Bạn có thể hỏi tôi bất kỳ thông tin nào về các bài viết trên blog này.', en: 'Hello! You can ask me anything about the articles on this blog.' },
  ai_assistant: { vi: 'Trợ lý AI', en: 'AI Assistant' },
  ask_about_articles: { vi: 'Hỏi về các bài viết của chúng tôi', en: 'Ask about our articles' },
  clear_chat: { vi: 'Xóa chat', en: 'Clear' },
  chat_sources: { vi: 'Nguồn tham khảo:', en: 'Sources:' },
  type_question_placeholder: { vi: 'Nhập câu hỏi của bạn...', en: 'Type your question...' },
  suggestion_hello: { vi: 'Xin chào', en: 'Hello' },
  suggestion_intro: { vi: 'Giới thiệu trang này là gì?', en: 'What is this site about?' },
  suggestion_purpose: { vi: 'Mục đích của blog là gì?', en: 'What is the purpose of this blog?' },
  suggestion_programming: { vi: 'Có bài viết nào về lập trình không?', en: 'Are there any programming articles?' },
  chat_error: { vi: 'Xin lỗi, đã xảy ra lỗi trong quá trình xử lý yêu cầu của bạn.', en: 'Sorry, I encountered an error while processing your request.' },
  ...
  posts_management: { vi: 'Quản Lý Bài Viết', en: 'Posts Management' },
  posts_management_desc: { vi: 'Tạo, chỉnh sửa, phân loại và quản lý các bài đăng của bạn.', en: 'Create, edit, categorize and manage all your posts.' },
  ...
  clear: { vi: 'Bỏ chọn', en: 'Clear' },
  all_categories: { vi: 'Tất cả chuyên mục', en: 'All Categories' },
  all_tags: { vi: 'Tất cả thẻ tag', en: 'All Tags' },
  delete: { vi: 'Xóa', en: 'Delete' },
  force_delete: { vi: 'Xóa vĩnh viễn', en: 'Force Delete' },
  total: { vi: 'Tổng số', en: 'Total' },
  delete_permanent_title: { vi: 'Xóa vĩnh viễn bài viết?', en: 'Permanently Delete Article?' },
  delete_soft_title: { vi: 'Xóa bài viết (Vào thùng rác)?', en: 'Delete Article (Soft Delete)?' },
  delete_permanent_msg: { vi: 'Bạn có chắc chắn muốn xóa vĩnh viễn bài viết này? Hành động này hoàn toàn không thể khôi phục lại.', en: 'Are you sure you want to permanently delete this article? This action is irreversible.' },
  delete_soft_msg: { vi: 'Bạn có chắc chắn muốn đưa bài viết này vào thùng rác? Bạn có thể khôi phục lại sau.', en: 'Are you sure you want to delete this article? You can restore it later from the deleted view.' },
  ...
  // Post Editor & Translate UI Localization keys
  editor_title_vi: { vi: 'Tiêu đề bài viết (VI)', en: 'Article Title (VI)' },
  editor_title_en: { vi: 'Tiêu đề bài viết (EN)', en: 'Article Title (EN)' },
  editor_slug_vi: { vi: 'Đường dẫn Slug VI', en: 'Post URL Slug VI' },
  editor_slug_en: { vi: 'Đường dẫn Slug EN', en: 'Post URL Slug EN' },
  editor_excerpt_vi: { vi: 'Tóm tắt ngắn (VI)', en: 'Short Excerpt (VI)' },
  editor_excerpt_en: { vi: 'Tóm tắt ngắn (EN)', en: 'Short Excerpt (EN)' },
  editor_content_vi: { vi: 'Nội dung bài viết (VI)', en: 'Article Content (VI)' },
  editor_content_en: { vi: 'Nội dung bài viết (EN)', en: 'Article Content (EN)' },
  editor_auto_translate: { vi: '🌐 Dịch tự động từ Tiếng Việt', en: '🌐 Auto-translate from Vietnamese' },
  editor_translating: { vi: 'Đang dịch...', en: 'Translating...' },
  editor_translate_success: { vi: 'Đã dịch tự động sang Tiếng Anh thành công!', en: 'Auto-translated to English successfully!' },
  editor_translate_error: { vi: 'Gặp lỗi khi dịch tự động: ', en: 'Error during auto-translation: ' },
  editor_vietnamese_tab: { vi: 'Tiếng Việt (Bản chính)', en: 'Vietnamese (Main)' },
  editor_english_tab: { vi: 'Tiếng Anh (Bản dịch)', en: 'English (Translation)' },
  editor_seo_title: { vi: 'Cấu hình SEO Metadata', en: 'SEO Metadata Config' },
  editor_google_preview: { vi: 'Xem trước kết quả Google', en: 'Google Search Preview' },
  editor_publish_settings: { vi: 'Thiết lập xuất bản', en: 'Publish Settings' },
  editor_is_pdf: { vi: 'Bài viết dạng tài liệu PDF', en: 'Is PDF Document Post' },
  editor_pdf_attached: { vi: 'File PDF đính kèm', en: 'Attached PDF File' },
  editor_select_pdf: { vi: 'Chọn file PDF', en: 'Select PDF File' },
  editor_pick_cover: { vi: 'Chọn ảnh bìa', en: 'Pick Cover Image' },
  editor_remove_cover: { vi: 'Xóa ảnh bìa', en: 'Remove Cover Image' },
  editor_taxonomy: { vi: 'Phân loại', en: 'Taxonomy' },
};
